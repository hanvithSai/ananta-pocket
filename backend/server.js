...
const app = express();
const PORT = process.env.PORT || 5000; // Set the port number from the environment variable or default to 5000
...
if (process.env.NODE_ENV === "production") {
  ...
  app.get("/{*splat}", (req, res) => {
    res.sendFile(path.resolve(__dirname, "frontend", "dist", "index.html")); // Serve the index.html file for any unknown routes (for React Router)
  });
}
